...
const DUMMY_CITIES: CityListItem[] = [
  {
    ...
    cityName: "도쿄",
    countryName: "일본",
    imgUrl: "https://picsum.photos/seed/tokyo/800/600",
  ...
  },
  {
    ...
    cityName: "파리",
    countryName: "프랑스",
    imgUrl: "https://picsum.photos/seed/paris/800/600",
  ...
  },
  {
    ...
    cityName: "뉴욕",
    countryName: "미국",
    imgUrl: "https://picsum.photos/seed/newyork/800/600",
  ...
  },
  {
    ...
    cityName: "시드니",
    countryName: "호주",
    imgUrl: "https://picsum.photos/seed/sydney/800/600",
  ...
  },
  {
    ...
    cityName: "방콕",
    countryName: "태국",
    imgUrl: "https://picsum.photos/seed/bangkok/800/600",
  ...
  },
  {
    ...
    cityName: "두바이",
    countryName: "UAE",
    imgUrl: "https://picsum.photos/seed/dubai/800/600",
  ...
  },
  {
    ...
    cityName: "바르셀로나",
    countryName: "스페인",
    imgUrl: "https://picsum.photos/seed/barcelona/800/600",
  ...
  },
  {
    ...
    cityName: "싱가포르",
    countryName: "싱가포르",
    imgUrl: "https://picsum.photos/seed/singapore/800/600",
  ...
  },
  {
    ...
    cityName: "로마",
    countryName: "이탈리아",
    imgUrl: "https://picsum.photos/seed/rome/800/600",
  ...
  },
  {
    ...
    cityName: "발리",
    countryName: "인도네시아",
    imgUrl: "https://picsum.photos/seed/bali/800/600",
  ...
  },
  {
    ...
    cityName: "암스테르담",
    countryName: "네덜란드",
    imgUrl: "https://picsum.photos/seed/amsterdam/800/600",
  ...
  },
  {
    ...
    cityName: "서울",
    countryName: "한국",
    imgUrl: "https://picsum.photos/seed/seoul/800/600",
  ...
  },
  {
    ...
    cityName: "이스탄불",
    countryName: "터키",
    imgUrl: "https://picsum.photos/seed/istanbul/800/600",
  ...
  },
  {
    ...
    cityName: "프라하",
    countryName: "체코",
    imgUrl: "https://picsum.photos/seed/prague/800/600",
  ...
  },
  {
    ...
    cityName: "칸쿤",
    countryName: "멕시코",
    imgUrl: "https://picsum.photos/seed/cancun/800/600",
...
export function GlobeViewer({ width, height }: GlobeViewerProps) {
  ...
  const { openRightPanel, globeBudgetFilter, globeRiskFilter, selectedCityCoords } = useUiStore();

  useEffect(() => {
    if (!selectedCityCoords) return;
    globeRef.current?.pointOfView(
      { lat: selectedCityCoords.lat, lng: selectedCityCoords.lng, altitude: 1.5 },
      1000,
    );
  }, [selectedCityCoords]);
  ...
  const handlePointClick = useCallback(
    (point: object) => {
      const city = point as CityListItem;
