...
async def scrape_google_explore():
    ...
    async with async_playwright() as p:
        ...
        try:
                    ...
                    for attempt in range(2):
                        ...
                        try:
                            ...
                            while len(flights_data) < 3:
                                flights_data.append({"Airline": "N/A", "Price": "N/A", "Stops": "N/A", "Duration": "N/A", "Is_Alternate_Airport": "N/A", "Alternate_Info": "N/A"})

                            # 2. 숙박 정보 추출 (섹션이 보일 수 있도록 살짝 스크롤)
                            try:
            ...
            print(f"[Error] Visual World Scan failed: {e}")
            traceback.print_exc()
